...
The code is somewhat (but not completely) written with 18 leg servos in mind. Only one leg is built currently, so I'm only able to test with three servos for the moment.
